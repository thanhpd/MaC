...
$avia_pages = array(
	...
	array( 'slug' => 'header', 		'parent'=>'avia', 'icon'=>"layout_select.png", 			'title' =>  __('Header Layout', 'avia_framework')),
	array( 'slug' => 'sidebars', 	'parent'=>'avia', 'icon'=>"layout_select_sidebar.png", 	'title' =>  __('Sidebar Layout', 'avia_framework')),
	array( 'slug' => 'footer', 		'parent'=>'avia', 'icon'=>"layout_select_footer.png", 	'title' =>  __('Footer Layout', 'avia_framework')),
...
$avia_elements[] =	array(
					"slug"	=> "upload",
					"name" 	=> __("Import Dummy Content: Posts, Pages, Categories", 'avia_framework'),
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("Upload a logo image, or enter the URL to an image if its already uploaded. The themes default logo gets applied if the input field is left blank<br/>Logo Dimension: 340px * 156px (if your logo is larger you might need to modify style.css to align it perfectly)", 'avia_framework'),
					"id" 	=> "logo",
					"type" 	=> "upload",
...
$avia_elements[] =	array(
					"slug"	=> "avia",
					"name" 	=> __("Responsive Layout active?", 'avia_framework'),
					"desc" 	=> __("By default the theme adapts to the screen size of the visitor and uses a layout best suited. You can disable this behavior so the theme will only show the default layout without adaptation. <br/><br/>If you choose to display responsive layout that adapts to the screen size, you can choose between 2 maximum width settings", 'avia_framework'),
					"id" 	=> "responsive_layout",
					"type" 	=> "select",
					"std" 	=> "responsive",
					"no_first"=>true,
					"subtype" => array( __('Active - Responsive Layout (Max width: 1030px)', 'avia_framework') =>'responsive',
										__('Active - Responsive Layout Large (Max width: 1210px)', 'avia_framework') =>'responsive responsive_large',
										__('Inactive - Fixed layout', 'avia_framework') =>'static_layout',
										));
...
$avia_elements[] = array(	"slug"	=> "styling", "type" => "visual_group_start", "id" => "avia_tab5", "nodescription" => true, 'class'=>'avia_tab avia_tab2','name'=>__('General', 'avia_framework'));
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("Background color for your site<br/><br/>", 'avia_framework'),
					"id" 	=> "color-body_color",
					"type" 	=> "colorpicker",
					"std" 	=> "#eeeeee",
					"class" => "av_2columns av_col_2",
...
$avia_elements[] =	array(
					"slug"	=> "sidebars",
					"name" 	=> __("Sidebar on Single Post Pages", 'avia_framework'),
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("Chose if and where to display social icons", 'avia_framework'),
					"id" 	=> "header_social",
					"type" 	=> "select",
					"std" 	=> "",
					"class" => "av_2columns av_col_1",
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("Chose if and where to display a secondary menu", 'avia_framework'),
...
$avia_elements[] =	array(
					...
					"desc" 	=> __("Upload a logo image, or enter the URL to an image if its already uploaded. (Leave empty to use the default logo)", 'avia_framework'),
