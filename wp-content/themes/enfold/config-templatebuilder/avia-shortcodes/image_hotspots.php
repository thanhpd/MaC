...
if ( !class_exists( 'avia_sc_image_hotspots' ) )
{
	class avia_sc_image_hotspots extends aviaShortcodeTemplate
	{
			...
			function shortcode_handler($atts, $content = "", $shortcodename = "", $meta = "")
			{
				...
				extract(shortcode_atts(array('animation'=>'no-animation', 'attachment'=>'', 'attachment_size' =>'', 'hotspot_layout'=>'', 'hotspot_mobile'=>''), $atts, $this->config['shortcode']));
			...
			function add_hotspot($hotspot, $counter, $extraClass = "")
			{
				...
				$output .= "<span class='av-image-hotspot-pulse' {$custom_pulse}></span>";
				$output .= "</div>";
